...
\begin{figure}[H]
  \centering 
  \includegraphics[width=8cm]{fig/DictSAR.eps}
...
\begin{figure}[H]
  \centering 
  \includegraphics[width=8cm]{fig/DictSIR.eps}
...
\begin{figure}[H]
  \centering 
  \includegraphics[width=9cm]{fig/ElectroFusionSIR.eps}
...
\begin{figure}[H]
  \centering 
  \includegraphics[width=9cm]{fig/ElectroFusionSAR.eps}
