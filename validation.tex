...
\end{enumerate} 
We are using a different database to tune the proposed method from the one in the evaluation phase in order to prevent any possible over-training and therefore to get the most accurate and fair comparison. 
