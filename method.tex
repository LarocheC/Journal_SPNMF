...
where $\otimes$ is the Hadamard product or element-wise product. Details of the equations for the Euc distance, KL and IS divergences are given in the annexe at \ref{euclidisteq}, \ref{KLdisteq} and \ref{ISdisteq} respectively. 
The algorithm for the SPNMF is organised as follows. We make the optimization sequentially in the algorithm \ref{AlgoMultipl}.
